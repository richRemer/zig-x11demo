...
pub const Message = union(Code) {
    ...
    focus_in: evt.FocusIn,
    focus_out: evt.FocusOut,
    keymap_notify: evt.KeymapNotify,
    expose: evt.Expose,
    graphics_exposure: GenericEvent,
    no_exposure: GenericEvent,
    visbility_notify: evt.VisibilityNotify,
    create_notify: GenericEvent,
    destroy_notify: GenericEvent,
    unmap_notify: GenericEvent,
    map_notify: evt.MapNotify,
    map_request: GenericEvent,
    reparent_notify: evt.ReparentNotify,
    ...
    property_notify: evt.PropertyNotify,
...
pub const Reply = union(req.Opcode) {
    ...
    get_window_attributes: rep.GetWindowAttributes,
    destroy_window: void,
    ...
    get_geometry: rep.GetGeometry,
    query_tree: rep.QueryTree,
    intern_atom: rep.InternAtom,
    get_atom_name: rep.GetAtomName,
    change_property: void,
    delete_property: void,
    get_property: rep.GetProperty,
    list_properties: rep.ListProperties,
    set_selection_owner: void,
    get_selection_owner: rep.GetSelectionOwner,
    convert_selection: void,
    send_event: void,
    grab_pointer: rep.GrabPointer,
    ungrab_pointer: void,
    grab_button: void,
    ungrab_button: void,
    change_active_pointer_grab: void,
    grab_keyboard: rep.GrabKeyboard,
    ...
    grab_server: void,
    ungrab_server: void,
    query_pointer: rep.QueryPointer,
    get_motion_events: rep.GetMotionEvents,
    translate_coordinates: rep.TranslateCoordinates,
    warp_pointer: void,
    set_input_focus: void,
    get_input_focus: rep.GetInputFocus,
    query_keymap: rep.QueryKeymap,
    open_font: void,
    close_font: void,
    query_font: rep.QueryFont,
    query_text_extents: rep.QueryTextExtents,
    list_fonts: rep.ListFonts,
    // TODO: ListFontsWithInfo | ListFontsWithInfoSentinel
    list_fonts_with_info: void,
    set_font_path: void,
    get_font_path: rep.GetFontPath,
    create_pixmap: void,
    free_pixmap: void,
    create_gc: void,
    change_gc: void,
    ...
    list_installed_colormaps: rep.ListInstalledColormaps,
    alloc_color: rep.AllocColor,
    alloc_named_color: rep.AllocNamedColor,
    alloc_color_cells: rep.AllocColorCells,
    alloc_color_planes: rep.AllocColorPlanes,
    free_colors: void,
    store_colors: void,
    store_named_color: void,
    query_colors: rep.QueryColors,
    lookup_color: rep.LookupColor,
    create_cursor: void,
    create_glyph_cursor: void,
    free_cursor: void,
    recolor_cursor: void,
    query_best_size: rep.QueryBestSize,
    query_extension: rep.QueryExtension,
    list_extensions: rep.ListExtensions,
    change_keyboard_mapping: void,
    get_keyboard_mapping: rep.GetKeyboardMapping,
    change_keyboard_control: void,
    get_keyboard_control: rep.GetKeyboardControl,
    bell: void,
    change_pointer_control: void,
    get_pointer_control: rep.GetPointerControl,
    set_screen_saver,
    get_screen_saver: rep.GetScreenSaver,
    change_hosts: void,
    list_hosts: rep.ListHosts,
    set_access_control: void,
    set_close_down_mode: void,
    kill_client: void,
    rotate_properties: void,
    force_screen_saver: void,
    set_pointer_mapping: rep.SetPointerMapping,
    get_pointer_mapping: rep.GetPointerMapping,
    set_modifier_mapping: rep.SetModifierMapping,
    get_modifier_mapping: rep.GetModifierMapping,
    no_operation: void,
};
